...
CURVE = 1.2                # the darkening curve — the difference-maker
                            # (tuned down from the 1.7 default: this photo's
                            # side light is already high-contrast, and 1.7
                            # crushed the shadow side of the face to solid black)
